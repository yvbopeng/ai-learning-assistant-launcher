...
import downloadTorrent from './WebTorrentAPI';
...
ipcMain.handle('torrent:start', async (_, magnetURI: string, downloadPath?: string) => {
  downloadTorrent(magnetURI, downloadPath);
  return { ok: true };
});
